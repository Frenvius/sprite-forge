...
export type ChartConfig = {
	...
	} & ({ theme?: never; color?: string } | { color?: never; theme: Record<keyof typeof THEMES, string> });
};
...
const ChartContext = React.createContext<null | ChartContextProps>(null);
...
>(({ payload, nameKey, className, hideIcon = false, verticalAlign = 'bottom' }, ref) => {
	const { config } = useChart();
...
export { ChartStyle, ChartLegend, ChartTooltip, ChartContainer, ChartLegendContent, ChartTooltipContent };
