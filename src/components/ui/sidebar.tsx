...
>(({ style, children, className, open: openProp, defaultOpen = true, onOpenChange: setOpenProp, ...props }, ref) => {
...
>(({ children, className, side = 'left', variant = 'sidebar', collapsible = 'offcanvas', ...props }, ref) => {
...
>(({ tooltip, className, asChild = false, isActive = false, size = 'default', variant = 'default', ...props }, ref) => {
	const Comp = asChild ? Slot : 'button';
...
>(({ isActive, className, size = 'md', asChild = false, ...props }, ref) => {
