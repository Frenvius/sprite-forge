...
- Highlights the active DAT/SPR/OTFI set in the file list.
...
- Collapsible DAT/SPR cards and a tidier asset panel layout.
...
- Context menu and multi-select in find results.
...
- Native context menu no longer appears in the find window.
